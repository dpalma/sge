...
interface IThreadCaller : IUnknown
{
   ...
   tResult PostCall(uint threadId, RETURN (* pfn)())
   {
   ...
   tResult PostCall(uint threadId, RETURN (* pfn)(ARG1), ARG1 arg1)
   {
   ...
   tResult PostCall(uint threadId, RETURN (* pfn)(ARG1, ARG2), ARG1 arg1, ARG2 arg2)
   {
   ...
   tResult PostCall(uint threadId, RETURN (* pfn)(ARG1, ARG2, ARG3), ARG1 arg1, ARG2 arg2, ARG3 arg3)
   {
