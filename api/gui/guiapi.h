...
F_DECLARE_INTERFACE_GUID(IGUIDragSource, "35EA0C5D-D1C0-4492-812C-2E040F4A6642");
...
///////////////////////////////////////////////////////////////////////////////
//
// INTERFACE: IGUIDragSource
//

interface IGUIDragSource : IUnknown
{
   virtual tResult QueryContinueDrag(const sInputEvent * pInputEvent) = 0;
};
