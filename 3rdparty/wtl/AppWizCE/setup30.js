...
// Setup program for the WTL App Wizard for EVC++ 3.0
...
function main()
{
	...
	var strEVC3Key = "HKLM\\Software\\Microsoft\\CEStudio\\3.0\\Setup\\CECommonDir";
	try
	{
		strValue = WSShell.RegRead(strEVC3Key);
	}
	catch(e)
	{
		WScript.Echo("ERROR: Cannot find where Embedded Visual C++ 3.0 is installed.");
		return;
	}
