...
// CLASS: EditorForm
//
// This class contains all the code generated by the Windows Forms Designer.
// Use a class derived from this to run the app.

ref class EditorForm : public System::Windows::Forms::Form
{
public:
   EditorForm();
   ~EditorForm();
