...
#pragma region Windows Form Designer generated code
   ...
   void EditorForm::InitializeComponent()
   {
      ...
      this->editorFormToolStrip->Location = System::Drawing::Point(0, 24);
      this->editorFormToolStrip->Name = L"editorFormToolStrip";
      this->editorFormToolStrip->Size = System::Drawing::Size(292, 25);
      ...
      this->Controls->Add(this->editorFormToolStrip);
